...
int main(int argc, char **argv){
    ...
    ros::init(argc, argv, "fp_wrenchRight_publisher");
    ros::NodeHandle n;
    ...
    //LOAD OF robot.mat
    iDynTree::MatrixDynSize forceplateWrenchRightArmForces_i = matrixFromMatlabExtractor_byString("forceplate.mat","forceplate/data/plateforms/plateform1/forces");
    iDynTree::MatrixDynSize forceplateWrenchRightArmMoments_i = matrixFromMatlabExtractor_byString("forceplate.mat","forceplate/data/plateforms/plateform1/moments");

    int j = 0;
    geometry_msgs::WrenchStamped wrenchMsgRight;
    ros::param::param<std::string>("~frame_id", wrenchMsgRight.header.frame_id, "forceplate1");

    while (ros::ok()){

        j++;
        if(j > (forceplateWrenchRightArmForces_i.cols())) j = 0;

        //compose WrenchStamped Msg
        wrenchMsgRight.header.stamp = ros::Time::now();
        wrenchMsgRight.wrench.force.x = forceplateWrenchRightArmForces_i.getVal(0,j);
        wrenchMsgRight.wrench.force.y= forceplateWrenchRightArmForces_i.getVal(1,j);
        wrenchMsgRight.wrench.force.z = forceplateWrenchRightArmForces_i.getVal(2,j);
        wrenchMsgRight.wrench.torque.x = forceplateWrenchRightArmMoments_i.getVal(0,j);
        wrenchMsgRight.wrench.torque.y = forceplateWrenchRightArmMoments_i.getVal(1,j);
        wrenchMsgRight.wrench.torque.z = forceplateWrenchRightArmMoments_i.getVal(2,j);
